...
# 1.rate of correct responses 2.RT of 0back 3.RT of 2 back to T_1 of standard measures (NIH toolbox List and Ravens WISC)


### Correlations between 3 fMRIs and List 

# Unscaled wm: rate of correct responses, wide 
